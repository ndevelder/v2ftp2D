...
void v2ftp2D::correct()
{
	...
	Pcart_ = symm((nfp_ & Pnfp_ ) & nfp_.T());
	
	phiProd_ = -k_*(fastGlm_.component(symmTensor::YY) - 0.4*GdK)/0.6;
	phiProd_ = mag(Pnfp_.component(symmTensor::YY));
